  ...
  return (
    <>
      ...
      <aside className={`
        ...
        w-64 bg-gradient-to-b from-slate-900 via-blue-900 to-indigo-900 text-white
      ...
      `}>
        ...
        <div className="p-4 border-t border-blue-700/50">
          <Link
            href="/auth/login"
            className="flex items-center space-x-3 px-4 py-3 rounded-xl hover:bg-red-600/20 transition-all duration-200 text-red-300 hover:text-white text-sm font-medium"
            onClick={onMenuClose}
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
